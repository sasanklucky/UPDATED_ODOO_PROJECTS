...
var _t = core._t;
var _lt = core._lt;
var ArsSalesTeamDashboardView = KanbanView.extend({
    ...
    _render: function () {
        ...
        var self = this;
         return this.fetch_data().then(function(result){
            ...
            var sales_dashboard = QWeb.render('java_test.ars_new_dashboard', {
                widget: this,
...
core.view_registry.add('', ArsSalesTeamDashboardView);

return ArsSalesTeamDashboardView;
