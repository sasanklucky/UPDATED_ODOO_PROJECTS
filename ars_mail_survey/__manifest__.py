{
    ...
    'version': '0.1',
    'depends': ['product', 'crm','mail', 'sale', 'ars_after_sales', 'account','survey','helpdesk','model_group'],
    'data': [
	...
	'views/ars_mail_activity_form_view.xml',
        ...
        'views/crm_psf_view.xml',
        'views/crm_psef_view.xml',
        'views/mail_activity_default_view.xml',
